...
public class Main {
	...
	public static void main(String[] args) {
		...
		cuenta2 = new CuentaCorriente("Juan López", "1000-2365-85-123456789", 2500, 0);
		do {
			try {
...
*/
		...
		vizualizarDatosCuenta(cuenta1, cuenta2);
	}

	private static void vizualizarDatosCuenta(CuentaCorriente cuenta1, CuentaCorriente cuenta2) {
